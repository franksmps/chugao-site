...
BLOG_META = {
    ...
    'blog-10': {
        ...
        'fr': {'title': "Variation des drivers LED expliquée : 0-10V, PWM, DALI et TRIAC", 'desc': "Ce que fait chaque norme (0-10V, PWM, DALI, TRIAC), laquelle spécifier et pourquoi driver et variateur doivent correspondre."},
        'de': {'title': "LED-Treiber-Dimming erklärt: 0-10V, PWM, DALI und TRIAC", 'desc': "Was jeder Standard bewirkt (0-10V, PWM, DALI, TRIAC), welchen Sie wählen und warum Treiber und Dimmer passen müssen."},
        'ar': {'title': "شرح تضبيب مشغلات LED: 0-10V وPWM وDALI وTRIAC", 'desc': "ماذا يفعل كل معيار (0-10V وPWM وDALI وTRIAC)، وأيًا تحدد، ولماذا يجب أن يتطابق المشغل مع المخفت."},
        'ja': {'title': "LED ドライバー調光の解説：0-10V・PWM・DALI・TRIAC", 'desc': "各規格（0-10V・PWM・DALI・TRIAC）の違い、どれを指定するか、ドライバーと調光器が一致する必要がある理由。"},
        'ko': {'title': "LED 구동장치 디밍 해설: 0-10V, PWM, DALI, TRIAC", 'desc': "각 규격(0-10V, PWM, DALI, TRIAC)의 차이, 무엇을 지정할지, 구동장치와 디머가 일치해야 하는 이유."},
